...
public class MainActivity8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdx = MediaPlayer.create(MainActivity8.this,R.raw.men);
        ...
        looping.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    mdx.setLooping(true);
                    Toast.makeText(MainActivity8.this, "تم تفعيل التكرار", Toast.LENGTH_SHORT).show();
                } else {
                    mdx.setLooping(false);
                    Toast.makeText(MainActivity8.this, "تم إيقاف التكرار", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
