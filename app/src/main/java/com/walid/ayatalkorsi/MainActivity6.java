...
public class MainActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdx = MediaPlayer.create(MainActivity6.this,R.raw.abdo);
        ...
        looping.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    mdx.setLooping(true);
                    Toast.makeText(MainActivity6.this, "تم تفعيل التكرار", Toast.LENGTH_SHORT).show();
                } else {
                    mdx.setLooping(false);
                    Toast.makeText(MainActivity6.this, "تم إيقاف التكرار", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
