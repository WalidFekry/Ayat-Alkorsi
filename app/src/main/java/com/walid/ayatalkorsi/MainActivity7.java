...
public class MainActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdx = MediaPlayer.create(MainActivity7.this,R.raw.abdo2);
        ...
        looping.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    mdx.setLooping(true);
                    Toast.makeText(MainActivity7.this, "تم تفعيل التكرار", Toast.LENGTH_SHORT).show();
                } else {
                    mdx.setLooping(false);
                    Toast.makeText(MainActivity7.this, "تم إيقاف التكرار", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
