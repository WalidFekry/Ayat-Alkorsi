...
public class MainActivity11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdx = MediaPlayer.create(MainActivity11.this,R.raw.rashed);
        ...
        looping.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    mdx.setLooping(true);
                    Toast.makeText(MainActivity11.this, "تم تفعيل التكرار", Toast.LENGTH_SHORT).show();
                } else {
                    mdx.setLooping(false);
                    Toast.makeText(MainActivity11.this, "تم إيقاف التكرار", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
